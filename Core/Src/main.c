...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LCD_RESET_Pin|MEM_SPI_CS__Pin|LCD_SPI_CS__Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_RESET_Pin MEM_SPI_CS__Pin LCD_SPI_CS__Pin */
  GPIO_InitStruct.Pin = LCD_RESET_Pin|MEM_SPI_CS__Pin|LCD_SPI_CS__Pin;
